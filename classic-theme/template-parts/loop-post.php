    ...
    <a href="<?php the_permalink(); ?>" class="module-Article_Item_Link">
        ...
        <div class="module-Article_Item_Body">
            ...
            <ul class="module-Article_Item_Meta">
                <?php
                    $s_category_list = get_the_category();
                    if ($s_category_list) :
                ?>
                    <li class ="module-Article_Item_Cat">
                        <?php echo esc_html($s_category_list[0]->name); ?>
                    </li>
                <?php endif; ?>
                <li class="module-Article_Item_Date"><time datetime="
                <?php echo get_the_date('Y-m-d'); ?>"><?php echo get_the_date(); ?></time></li>
            </ul>
        </div>
    </a>
</article>